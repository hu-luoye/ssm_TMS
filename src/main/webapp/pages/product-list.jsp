                ...
                <div class="box-body">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${pageInfo.list}" var="product" >
                                <tr>
                                    ...
                                    <td class="text-center">${product.productStaus}</td>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/product/findAll/1/${pageInfo.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/product/findAll/${pageInfo.pageNum-1}/${pageInfo.pageSize}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/product/findAll/${pageNum}/${pageInfo.pageSize}">${pageNum}</a></li>
                                </c:forEach>

                                <li><a href="${pageContext.request.contextPath}/product/findAll/${pageInfo.pageNum+1}/${pageInfo.pageSize}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/product/findAll/${pageInfo.pages}/${pageInfo.pageSize}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求
        location.href = "${pageContext.request.contextPath}/product/findAll/1/" + pageSize;
    }
